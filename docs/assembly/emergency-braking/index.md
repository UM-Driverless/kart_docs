...
*   **Unpowered (0V/0mA):**
    ...
    *   **Proof:** See datasheet functional diagram (3-way regulator). The reset position (spring) closes supply and opens exhaust to 0 bar. [Datasheet](../../assets/datasheets/VPPM_en.pdf#page=1)
